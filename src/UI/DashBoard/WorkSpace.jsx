  ...
  return (
     <div>
          ...
          <div className="w-full md:w-screen min-h-screen flex flex-col items-center gap-8 bg-blue-600">
              <button onClick={()=>navigate('/workspaceform')} className="btn btn-accent text-2xl py-6 mt-4 mr-6">Create WorkSpace</button>
                      {
                         workSpaceList.length !== 0 && (<div className="w-80 mr-6 md:w-6xl h-fit p-4 bg-black">
