...
const ProjectPage = () => {
  ...
  return (
    <div className="bg-amber-600 flex flex-col w-full md:w-screen min-h-screen">
       <div className="mt-4 font-semibold text-2xl md:text-4xl py-2 text-center">{projectName.project_Name}</div>
       {/* Kanban Board */}
       <div className="w-full md:w-screen h-[60vh] md:h-[80vh] mt-4 p-4 md:pt-8 flex justify-center items-start md:justify-evenly gap-2">
