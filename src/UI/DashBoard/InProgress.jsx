...
const InProgress = ({id,taskUI,setTaskUI,workSpace}) => {
    ...
    const inProgressTasks = taskUI?.filter(t => t.status === 'in-progress')|| [];//array of inProgressTasks only
    ...
    const handleTask = (e)=>{
          ...
          .catch((error)=>{
            ...
            console.log("Couldn't submitted In Progress task to database & errorCode is : ",errorCode);
            const errorMessage = error.message;
            console.log("Couldn't submitted In Progress task to database & errorMessage is : ",errorMessage);
    ...
    <div>
            {
                ...
                <div onMouseLeave={()=>setHeading(false)} className="flex">
                 <div className="bg-pink-500 rounded-md pl-1.5 w-23 mt-2 ml-2.5 md:ml-2 md:mt-4 md:w-78 md:text-2xl">IN PROGRESS</div>
                ...
                <div onMouseEnter={()=>setHeading(true)} className="flex">
                   <div className="mt-2 ml-2.5 pl-1.5 rounded-md w-23 md:text-2xl md:ml-2 md:mt-4 md:w-78">IN PROGRESS</div>
                </div>
